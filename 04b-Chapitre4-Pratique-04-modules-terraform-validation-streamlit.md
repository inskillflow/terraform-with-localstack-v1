...
# TP 4 — Organiser Terraform avec des modules et valider avec Streamlit

> **Cours visé :** Terraform, Infrastructure as Code, modules Terraform, LocalStack, Streamlit  
>
> **Niveau :** Débutant avancé  
>
> **Prérequis :** les TP 1, 2 et 3 doivent être réalisés. Le projet contient déjà S3, DynamoDB, SQS, des variables, des outputs et un dashboard Streamlit.  
>
