...
# TP 2 — Dashboard Streamlit pour valider les ressources créées avec Terraform

> **Cours visé :** Terraform, Infrastructure as Code, LocalStack, validation d’infrastructure, Streamlit  
>
> **Niveau :** Débutant complet  
>
> **Prérequis :** le TP 1 doit déjà être réalisé. LocalStack doit être démarré et Terraform doit avoir créé un bucket S3 et une table DynamoDB.  
>
...
Dans `.env.example`, mettez les mêmes noms de variables, mais sans vrai token :
