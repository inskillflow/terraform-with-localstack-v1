...
# TP 3 — Ajouter une file SQS avec Terraform et la valider dans Streamlit

> **Cours visé :** Terraform, Infrastructure as Code, LocalStack, SQS, Streamlit, validation d’infrastructure  
>
> **Niveau :** Débutant avancé  
>
> **Prérequis :** les TP 1 et 2 doivent être réalisés. Le projet contient déjà S3, DynamoDB, des variables Terraform, des outputs et un dashboard Streamlit.  
>
