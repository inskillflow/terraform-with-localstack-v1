...
from lib.aws_clients import bucket_name, localstack_endpoint, read_terraform_outputs, table_name


st.set_page_config(page_title="Terraform outputs", page_icon=":memo:")
st.title("Terraform outputs")
st.caption("Comparaison entre les outputs Terraform et le fichier .env.")
