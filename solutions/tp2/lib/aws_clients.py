"""Clients boto3 configures pour parler a LocalStack."""
...
def load_env() -> dict[str, str]:
    """Charge .env et retourne les variables pertinentes pour l'app."""
...
def read_terraform_outputs() -> dict[str, Any]:
    """Execute `terraform output -json` et retourne un dict {nom: valeur}."""
